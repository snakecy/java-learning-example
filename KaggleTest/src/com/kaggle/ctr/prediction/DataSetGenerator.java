package com.kaggle.ctr.prediction;
...
public class DataSetGenerator {
    ...
    public void loadUsers() {
        ...
        String fileName = "/data/track2/userid_profile.txt";
    ...
    public void sampleTraining(String fileName) {
        try {
            ...
            String file = "/data/project/training.txt";
    ...
    public void procTesting(String fileName) {
        try {
            BufferedReader bufferReader = new BufferedReader(new InputStreamReader(new FileInputStream(fileName)));
            String readPerLine = new String();
            String file1 = "/data/project/test/newTest.txt";
            String file2 = "/data/project/test/newUserTest.txt";
            String file3 = "/data/project/test/newAdvTest.txt";
    ...
    public void procSolution(String fileName) {
        ...
        try {
            BufferedReader bufferReader = new BufferedReader(new InputStreamReader(new FileInputStream(fileName)));
            String readPerLine = new String();
            String file1 = "/data/project/solution/newSol.txt";
            String file2 = "/data/project/solution/newUserSol.txt";
            String file3 = "/data/project/solution/newAdvSol.txt";
    ...
    public void procContent() {
        ...
        String inputPath = "/data/track2/";
        String outputPath = "/data/project/";
    ...
    public static void main(String[] args) {
        ...
        String dataPath = "/data/track2/training.txt";
        String testPath = "/data/track2/test.txt";
        String solPath = "/data/csv/KDD_Track2_solution.csv";
